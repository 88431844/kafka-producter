...
public class PushEventRecordEntity extends KafkaCommand implements Serializable {
    private Long id;
    ...
    public Double getDifferOil() {
        return differOil;
    }

    public void setDifferOil(Double differOil) {
        this.differOil = differOil;
    }
